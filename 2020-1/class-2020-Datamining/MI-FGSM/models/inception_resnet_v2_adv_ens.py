...
inception = tf.keras.applications.InceptionV3(input_shape=[160, 160, 3], include_top=False, weights='imagenet')
...
inception_model.set_weights(inception_res)


resnet_model = Model(inception)
resnet_model.build((None,160,160,3))
resnet_model.set_weights(inception_v3_weight)
...
for e in range(EPOCHS):
    ...
    if best_loss > train_loss.result() and MODEL_SAVE:
        ...
        path = f'../weights/model_Inception_res_adv_ens'
