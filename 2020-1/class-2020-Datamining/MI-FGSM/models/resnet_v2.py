...
base_model = tf.keras.applications.ResNet152V2(input_shape=[160, 160, 3], include_top=False,weights='imagenet')
...
for e in range(EPOCHS):
    ...
    if best_loss > train_loss.result() and MODEL_SAVE:
        ...
        path = f'../model/model_resnet152V2_{e}_{train_acc.result():.2f}_{train_loss.result():.4f}'
